...
//            throw (new Exception("月份有错！"));
    ...
    public static String yang2ying(LocalDate endDate) {
    ...
    public static String yang2ying(String endDate) {
        return yang2ying(LocalDate.parse(endDate, dateTimeFormatter));
    }
